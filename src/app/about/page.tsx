...
export const metadata: Metadata = {
  title: "About Us — ResumeForge | Domain Expansion",
  description: "About ResumeForge and Domain Expansion — our mission, company, and technology.",
};

export default function AboutPage() {
  return (
    <LegalPageLayout title="About ResumeForge" lastUpdated={new Date().toLocaleDateString("en-IN")}>
      <p>ResumeForge is a product of <strong>Domain Expansion</strong>, a technology company based in Bengaluru, India. We build tools that empower individuals to present their professional best.</p>

      <h2 className="text-lg font-bold mt-6 mb-2">Our Mission</h2>
      <p>We believe everyone deserves a professional resume. Our platform makes it easy to create beautiful, ATS-friendly resumes that get you noticed by recruiters. With 52 templates, AI-powered writing tools, and one-click export, ResumeForge is the complete resume building solution.</p>
      ...
      <p>Domain Expansion is the parent company of ResumeForge. We are committed to building innovative products that solve real problems for job seekers and professionals worldwide.</p>
      ...
      <p>ResumeForge is built with modern technology:</p>
      <ul className="list-disc pl-5 space-y-1">
